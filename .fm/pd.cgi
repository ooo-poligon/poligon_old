...
if ($last == ("backup.php3", "clCard.php3", 
"config.php3", "crontab.php3", "customer_index.php3", 
"db.php3", "db_admin.php3", "db_create.php3", 
"db_password.php3", "db_remove.php3", "edit.php3", 
"errors.php3", "fileman.php3", "fileman_install.php3", 
"fileman_pwd.php3", "fm.php3", "mail_manager.php3", 
"mail_manager_autoresponder.php3", "mail_manager_creat.php3", 
"mail_manager_forward.php3", "mail_manager_pwd.php3", 
"password_form.php3", "pg_create.php3", "pg_password.php3", 
"pg_remove.php3", "pgsql.php3", "protect_dirs.php3", 
"ssh.php3", "upgrade.php3", "vd.php3", "vd_add.php3", 
"vd_remove.php3", "pd.php3"))
{
...
# --------------------------------------------------------
	...
	script_url	=> 'http://neo.sweb.ru/~poliinfo/.fm/pd.cgi',
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="24">
  ...
  <tr> 
    <td height="1" bgcolor="606090" width="100%"><img src="http://www.sweb.ru/img/cp3.gif" width="1" height="1"></td>
  </tr>
</table>
...
<td valign="top" width="20" height="100%"><table width="20" border="0" cellspacing="0" cellpadding="0"><tr><td width="20" height="20" bgcolor="D0D0EF"><img src="http://www.sweb.ru/img/e.gif" width="20" height="1"></td></tr></table>
 ...
 <td valign="top">
  ...
  <TABLE BORDER="0" cellpadding="2" CELLSPACING="0" WIDTH="100%">
    <TR>      
      <TD bgcolor="D0D0EF" height="20" width="*">
       <B><FONT FACE="MS Sans Serif" SIZE="2" color="#000000">Паролирование директорий</FONT></B>
      </TD>
    </TR>
    <TR>
      <TD VALIGN="top"><FONT SIZE="2" FACE="MS Sans Serif"><A HREF="$for_link/customer_index.php3"><B>Главная страница</B></A> | <A HREF="javascript:history.go(-1)">Назад</A>
        |<BR>
        </FONT></TD></tr>
  </TABLE>
  ...
  <table border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1" width="595" align="center" valign="top">
        <tr><td>
  <br><br><FONT SIZE="2" FACE="MS Sans Serif">Чтобы защитить паролем и логином тот или иной каталог, выберите нужный каталог и нажмите на ссылку "Защитить директорию"
  </td></tr></table>
    ...
    print qq~
        ...
        <table border=0 bgcolor="#FFFFFF" cellpadding=5 cellspacing=3 width=100% valign=top>
            <tr>
                ...
                <td align="right"><B>
<a href="javascript:alert($diskUsage)"><FONT FACE="MS Sans Serif" SIZE="1">Дисковое пространство</font></a></B></td>
            </tr>
            <tr>
                <td></td>
                <td align="right"></td>
...
# Regular directory.
                ...
                $directory{$file} .= qq~     <td><b><a href="$config{'script_url'}?action=protect_form&wd=$working_dir&dir=$file"><FONT FACE="MS Sans Serif" SIZE="1" сolor=brown>Защитить директорию</font></A></b></td>\n~ if ($config{'show_pass'});
                $directory{$file} .= qq~ </tr>\n~;              
            }
        }
# Text Files.
    ...
    if ($#users > -1) {
        ...
        print qq~
                    <form action="$config{'script_url'}" method="post">
                        ...
                        <input type=hidden name="wd" value="$working_dir">
                        <input type=hidden name="dir" value="$directory">
                        <FONT FACE="MS Sans Serif" SIZE="2"> пользователя: <select name='user'>$user_list</select> <input type=submit value="Удалить пользователя">   
                    </form>
        ~;
    }   
}                   
