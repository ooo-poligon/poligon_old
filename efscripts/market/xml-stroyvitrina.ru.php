...
$sections = array(
				//'Реле времени/таймер' => array(4996, 160, 4999, 5000, 5128, 5003, 4997, 5002, 5420, 5417, 5418, 5416, 5040), // тут же и лестничные 5420 + цифровые таймеры теле
				//'Термостат' => array(5457, 5458, 5536),
				'Фотореле' => array(5454), //Умный дом. Системы интеллектуальной автоматизации
				//'Счётчик часов' => array(5423, 5041),
				'Устройство плавного пуска' => array(162, 5030, 5029, 163),
				'Автоматические выключатели' => array(5520, 5519), // Автоматические выключатели, УЗО — CBI
				'Трансформаторы' => array(5035), // Трансформаторное оборудование
				'Термостаты' => array(5422, 5536),// Теплый пол, нагревательные кабели
				'Контакторы' => array(5263, 5264, 5266), // Контакторы, пускатели, реле
				);
