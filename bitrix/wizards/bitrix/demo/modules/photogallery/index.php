...
else
{
	...
	$res = ImportXMLFile($source_base."photogallery_".LANGUAGE_ID.".xml", "gallery", $SITE_ID);
...
// 3.2 Add Forum
	...
	if ($FID <= 0):
		$arFields = Array(
			...
			"USE_CAPTCHA" => "Y",
			"SITES" => array(
				$SITE_ID => "/communication/forum/index.php?PAGE_NAME=read&FID=#FORUM_ID#&TID=#TOPIC_ID#&MID=#MESSAGE_ID##message#MESSAGE_ID#"),
			"EVENT1" => "forum", 
			"EVENT2" => "message",
			"EVENT3" => "",
			"GROUP_ID" => array(
...
$PhotoRandom = '
	...
	Array("IBLOCK_TYPE" => "gallery", 
		...
		"DETAIL_URL" => "'.$target.'index.php?PAGE_NAME=detail&SECTION_ID=#SECTION_ID#&ELEMENT_ID=#ELEMENT_ID#", 
		"CACHE_TYPE" => "A", 
		"CACHE_TIME" => "180")
	);?></div>';
