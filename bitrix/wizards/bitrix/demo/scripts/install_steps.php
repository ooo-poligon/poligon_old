...
class InstallTemplateData extends CWizardStep
{
	...
	function OnPostForm()
	{
		...
		$themePath = $_SERVER["DOCUMENT_ROOT"].$wizard->GetPath()."/templates/".$templateID."/themes/".$themeID;
...
class InstallServices extends CWizardStep
{
	function InitStep()
	{
		$this->SetTitle("Установка сервисов");
	}
	...
	function GetFirstStep(&$arServices)
	{
		...
		return Array("service_not_found", "__finish", "Установка завершена");
	}
