	...
	<td valign="top" width="60%">
		...
		<table class="sale_order_full data-table">
			...
			<tr>
				...
				<td align="right" colspan="4"><?=$arResult["ORDER_PRICE_FORMATED"]?></td>
			</tr>
			<?
			if (doubleval($arResult["DISCOUNT_PRICE_FORMATED"]) > 0)
			{
				...
				<tr>
					...
					<td align="right" colspan="4"><?echo $arResult["DISCOUNT_PRICE_FORMATED"]?>
			...
			if (doubleval($arResult["VAT_PRICE_FORMATED"]) > 0)
			{
				?>
				<tr>
					<td align="right">
					...
					<td align="right" colspan="4"><?=DoubleVal($arResult["VAT_PRICE_FORMATED"])?></td>
				</tr>
				<?
			}
			...
			if (doubleval($arResult["DELIVERY_PRICE_FORMATED"]) > 0)
			{
				?>
				<tr>
					<td align="right">
					...
					<td align="right" colspan="4"><?=$arResult["DELIVERY_PRICE_FORMATED"]?></td>
				</tr>
				<?
			}
			?>
			<tr>
				...
				<td align="right" colspan="4"><b><?=$arResult["ORDER_TOTAL_PRICE_FORMATED"]?></b>
				</td>
			</tr>
			<?
			if (doubleval($arResult["PAYED_FROM_ACCOUNT_FORMATED"]) > 0)
			{
				...
				<tr>
					...
					<td align="right" colspan="4"><?=$arResult["PAYED_FROM_ACCOUNT_FORMATED"]?></td>
				</tr>
				<?
			}
			?>
