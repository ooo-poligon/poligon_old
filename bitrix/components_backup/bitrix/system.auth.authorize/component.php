...
$arResult["AUTH_FORGOT_PASSWORD_URL"] = $APPLICATION->GetCurPageParam("forgot_password=yes", array(
		"login",
	     "logout",
	     "register",
	     "forgot_password",
...
$arResult["AUTH_CHANGE_PASSWORD_URL"] = $APPLICATION->GetCurPageParam("change_password=yes", array(
		"login",
	     "logout",
	     "register",
	     "forgot_password",
