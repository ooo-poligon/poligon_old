...
*/
$arParams["REGISTER_URL"] = strlen($arParams["REGISTER_URL"]) > 0 ? $arParams["REGISTER_URL"] : $APPLICATION->GetCurPageParam("", array(
			"login",
		    "logout",
		    "register",
		    "forgot_password",
...
if (!$USER->IsAuthorized())
{
	...
	{ 
		$arResult["AUTH_URL"] = $APPLICATION->GetCurPageParam("login=yes", array(
			"login",
		    "logout",
		    "register",
		    "forgot_password",
	...
	/*
	$arResult["AUTH_REGISTER_URL"] = $APPLICATION->GetCurPageParam("register=yes", array(
			"login",
		    "logout",
		    "register",
		    "forgot_password",
	...
	*/
	...
	$arResult["AUTH_REGISTER_URL"] = $arParams["REGISTER_URL"] . ($bRegisterURLque ? "&" : "?") . "register=yes&backurl=" . 
		urlencode($APPLICATION->GetCurPageParam("", array(
			"login",
		    "logout",
		    "register",
		    "forgot_password",
	...
	$arResult["AUTH_FORGOT_PASSWORD_URL"] = $arParams["REGISTER_URL"] . ($bRegisterURLque ? "&" : "?") . "forgot_password=yes&backurl=".urlencode($APPLICATION->GetCurPageParam("", array(
			"login",
		    "logout",
		    "register",
		    "forgot_password",
...
else
{
	...
	{ 
		$arResult["AUTH_URL"] = $APPLICATION->GetCurPageParam("", array(
			"login",
		    "logout",
		    "register",
		    "forgot_password",
