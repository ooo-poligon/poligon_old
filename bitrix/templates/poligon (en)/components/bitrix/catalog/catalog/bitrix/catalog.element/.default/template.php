...
<div class="abs">
	<table class="price" border="0" cellspacing="0" cellpadding="2" width="234">
		<tr>
			<td align="center" width="100%" colspan=2 class="catalog-price-1">Цена: <b><?=FormatCurrency($arResult["PRICE_MATRIX"]["MATRIX"][1][0]["PRICE"], $arResult["PRICE_MATRIX"]["MATRIX"][1][0]["CURRENCY"])?></b></td>
		</tr>
		<tr>
...
<?if(is_array($arResult["PRICE_MATRIX"])):?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<?if($arResult["PROPERTIES"]["pdf"]["VALUE"]){
				echo '<tr><td><table><tr><td>Дополнительная информация:</td><Td> <a href="'.$arResult['PROPERTIES']['pdf']['VALUE'].'"><img src="/images/pdf.jpg" height="50"></a></td></tr></table></td></tr>';?>
<?}?>
	</table>
