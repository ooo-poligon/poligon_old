...
foreach($arResult["SECTIONS"] as $arSection):
	...
	elseif($CURRENT_DEPTH>$arSection["DEPTH_LEVEL"])
		echo str_repeat("</ul><br><br>", $CURRENT_DEPTH - $arSection["DEPTH_LEVEL"]);
	...
	if($arSection["DEPTH_LEVEL"]==1)
	{
		...
		{ 
			...
			$sec_preview = $arSect["UF_SECT_PREVIEW"];
                ...
                echo '<li><table><tr>';
		if ($arSection["PICTURE"]) echo '<td><img alt="'.$img_alt.'" src="'.$arSection["PICTURE"]["SRC"].'" width="80" height="80" style="float:left;" /></td>';
