...
<html>
	...
	<head>
		...
		<link href="/bitrix/templates/poligon_ibx_citel/template_styles.css" rel="stylesheet" type="text/css" media="all" />
		<link href="/bitrix/templates/poligon_ibx_citel/template_styles_1600.css" rel="stylesheet" type="text/css" media="(max-width: 1599px)" />
...
<!--#################################################################################################################-->
	...
	<?php $APPLICATION->IncludeFile("/bitrix/templates/poligon_i/header_for_all.php"); ?>
			...
			<div id="print"><a href='<?=$APPLICATION->GetCurPageParam("print=Y")?>'><img src="/images/printer.gif" width="16" style="vertical-align: top" alt="print" />Версия для печати</a></div><br>
