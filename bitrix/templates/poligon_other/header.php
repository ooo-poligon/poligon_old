...
<script>
   function goForward() {
	i = window.location.toString().search;
	//location.href = 'http://mail.ru' + i;
	alert i;
   }
  </script>
	...
	<div id="catalog">
	  <div id="right">
		<div id="partners">
			...
			<a href="/content/program/">Наши партнеры</a>	
			<?$APPLICATION->IncludeFile(
...
<center>
    ...
    <form>
        ...
        <input type="button" onclick="goForward()" value="Вперед"></input>
    </form>
...
<div id="print"><a href='<?=$APPLICATION->GetCurPageParam("print=Y")?>'><br><img src="/images/printer.jpg" width="16" width="16" align="top">Версия для печати</a></div>
