...
<div class="abs">
	<table align="center" class="price" border="0" cellspacing="0" cellpadding="2" width="234">
		<tr>
			<td align="center" width="100%" colspan=2 class="catalog-price-1">Цена: <b><?//=$arResult["PRICES"]["BASE"]["PRINT_VALUE"]?><?=FormatCurrency($arResult["PRICE_MATRIX"]["MATRIX"][1][0]["PRICE"], $arResult["PRICE_MATRIX"]["MATRIX"][1][0]["CURRENCY"])?></b></td>
		</tr>
		<tr>
...
<?if(is_array($arResult["PRICE_MATRIX"])):?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<tr>
			...
			<?=CFile::ShowImage('/images/'.$arResult["PROPERTIES"]["link"]["VALUE"], 200, 200, "border=0 alt='".$img_alt."' style='vertical-align:text-top; margin-right:10px'", "", false,false);?></td><td valign="top">
		...
		<?if($arResult["PROPERTIES"]["pdf"]["VALUE"]){
				echo '<tr><td><table><tr><td>Техническая информация:</td><Td> <a href="/PDF/'.$arResult['PROPERTIES']['pdf']['VALUE'].'"><img src="/images/pdf_doc.gif"></a></td></tr></table></td></tr>';?>
<?}?>
	</table>
