	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
			<td>
				...
				elseif($arResult["PROPERTIES"]["srok"]["VALUE"])
					$onStore = "Срок поставки: {$arResult["PROPERTIES"]["srok"]["VALUE"]}";
				else
					$onStore = "Уточните наличие и сроки поставки по телефону (812)325-42-20";
			...
			<table>
				<tr>
					<td valign="top">
						...
						<!--
						<?=CFile::ShowImage('/images/'.$arResult["PROPERTIES"]["link"]["VALUE"].'.img', 200, 200, "border=0 alt='".$img_alt."' style='vertical-align:text-top; margin-right:10px'", "", false,false);?>
						-->
...
//	$LINE_ELEMENT_COUNT = 2; // number of elements in a row
	...
	<table class="images-<?=count($photosArr);?>">
	<thead><tr>
	...
	<tbody><tr>
		<?foreach($photosArr as $img => $title):?>
			<td><img src="/images/<?=$img;?>" alt="<?=$title;?>" title="<?=$title;?>" class="show"/></td>
		<?endforeach?>
	</tr></tbody>
	</table>
	<?endif?>
