...
<?if(is_array($arResult["PRICE_MATRIX"])):?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<Tr>
			<Td><?//var_dump($arResult["PRICES"]);?><b><?=$arResult["PREVIEW_TEXT"]?></b><br><small><?=$section_name?></small></td>
		</tr>
		<tr>
		...
		<?if($arResult["PROPERTIES"]["pdf"]["VALUE"]){
				echo '<tr><td><table><tr><td>Дополнительная информация:</td><Td> <a href="'.$arResult['PROPERTIES']['pdf']['VALUE'].'"><img src="/images/pdf_doc.gif"></a></td></tr></table></td></tr>';?>
<?}?>
	</table>
