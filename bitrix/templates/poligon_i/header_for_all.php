			...
			<section id="contacts">
								...
								<td align="center" valign="top">
									...
									<div style="text-align:left; width:320px;">	
										<?php
											...
											$goSend[To]='webmaster-poligon@yandex.ru'; // направляем письмо в указанный ящик
				...
				<section class="top_background">
					<a href="/index.php" class="site_logo">
						<img class="site_logo_image" src="/bitrix/templates/poligon_i/images/logo.png" alt="Логотип ООО ПОЛИГОН"/>
					</a>
