...
$MESS["ELEMENT_ID_TIP"] = "Поле содержит код, в котором передается ID элемента. Например: 39";
$MESS["SECTION_ID_TIP"] = "Поле содержит код, в котором передается ID раздела. Например: 39";
