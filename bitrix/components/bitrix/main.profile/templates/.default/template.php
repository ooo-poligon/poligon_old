...
<table class="data-table profile-table">
	...
	<tbody>
		...
		<tr>
			...
			<td>
			<input type="hidden" name="PERSONAL_PHOTO_ID" value="<?=$arResult["arUser"]["PERSONAL_PHOTO"]?>" />
...
<table class="data-table profile-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><input type="hidden" name="WORK_LOGO_ID" value="<?=$arResult["arUser"]["WORK_LOGO"]?>" />
