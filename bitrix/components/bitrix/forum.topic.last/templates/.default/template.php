...
?><table class="data-table"><?
	...
	?><tr><?
		?><td><?
			...
			?><?=str_replace("#FORUM#", "<a href =\"".$arResult["FORUM"][$res["FORUM_ID"]]["list"]."\">".$arResult["FORUM"][$res["FORUM_ID"]]["NAME"]."</a>", $arParams["SEPARATE"])
		?></td><?
		...
		?><td class="last_post_date"><?
			?><a href="<?=$res["read_last_message"]?>" title="<?=GetMessage("FTP_LAST_MESS")?>"><?
			?><?=$res["LAST_POST_DATE"]?><?
			?></a><?
			?></td><?
		endif;
