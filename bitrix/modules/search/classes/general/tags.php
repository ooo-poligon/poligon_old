	...
	function GetList($arSelect = array(), $arFilter = array(), $arOrder = array(), $limit = 100)
	{
		...
		$strSql = "
			...
			FROM b_search_tags stags
				".($USER->IsAdmin()?"": "INNER JOIN b_search_content_group scg ON stags.SEARCH_CONTENT_ID=scg.SEARCH_CONTENT_ID AND scg.GROUP_ID IN (".$USER->GetGroups().")")."
