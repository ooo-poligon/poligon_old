...
if ($arTopic)
	$res = "[<a title='".GetMessage("FORUM_VIEW_TOPIC")."' class='tablebodylink' href='/bitrix/admin/forum_topics.php?lang=".LANG."'>".intVal($arTopic["ID"])."</a>] (".htmlspecialchars($arTopic["TITLE"]).") ";
else
