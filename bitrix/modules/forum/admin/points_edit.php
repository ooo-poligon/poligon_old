...
if ($ID>0)
{
	...
	$db_points->ExtractFields("str_", True);
}
...
$sDocTitle = ($ID>0) ? eregi_replace("#ID#", "$ID", GetMessage("FORUM_PE_TITLE_UPDATE")) : GetMessage("FORUM_PE_TITLE_ADD");
...
?>
	...
	<tr>
		...
		<td width="60%">
			<input type="text" name="MIN_POINTS" value="<?echo $str_MIN_POINTS ?>" size="10">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" name="CODE" value="<?echo $str_CODE ?>" size="30">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" name="VOTES" value="<?echo $str_VOTES ?>" size="10">
		</td>
	</tr>
	...
	for ($i = 0; $i < count($arSysLangs); $i++):
		...
		$str_NAME = htmlspecialchars($arPointsLang["NAME"]);
		if ($bInitVars)
		{
