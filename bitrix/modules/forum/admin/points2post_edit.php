...
$sDocTitle = ($ID>0) ? eregi_replace("#ID#", "$ID", GetMessage("FORUM_PPE_TITLE_UPD")) : GetMessage("FORUM_PPE_TITLE_ADD");
...
?>
	...
	<tr>
		...
		<td width="60%">
			<input type="text" name="MIN_NUM_POSTS" value="<?echo $str_MIN_NUM_POSTS ?>" size="10">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" name="POINTS_PER_POST" value="<?echo $str_POINTS_PER_POST ?>" size="10">
		</td>
	</tr>
<?
$tabControl->EndTab();
