				...
				<table cellpadding='2' cellspacing='2' width='100%' align='center'>
					...
					<tr>
						<td align='left'>
							...
							<!--<input type='button' accesskey='t' value=' Translit ' onClick='translit()' style="font-size: 8.5pt; font-family: verdana, helvetica, sans-serif; vertical-align: middle" name="TRANSLIT" title="Translit (alt + t)" onMouseOver="show_hints('translit')">-->
						</td>
					</tr>
					<tr>
