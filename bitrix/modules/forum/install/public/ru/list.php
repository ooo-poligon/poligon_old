	...
	while ($db_Topic->NavNext(true, "f_", true)):
		...
		<tr class="forumbody">
			<td align="center" class="forumbodytext">
				...
				{
					?><a href="read.php?FID=<?echo $f_FORUM_ID;?>&TID=<?echo $f_ID?>&MID=<?echo $FirstUnreadedMessageID?>#message<?echo $FirstUnreadedMessageID?>"><img src="/bitrix/images/forum/f_<?echo $strClosed; ?>norm.gif" width="18" height="12" alt="Есть новые сообщения!" border="0"></a><?
				}
				else
				{
					?><img src="/bitrix/images/forum/f_<?echo $strClosed; ?>norm_no.gif" width="18" height="12" alt="Нет новых сообщений" border="0"><?
				}
				?>
			</td>
			<td align="center" class="forumbodytext">
			...
			<td class="forumbodytext">
				...
				<a href="read.php?FID=<?echo $f_FORUM_ID;?>&TID=<?echo $f_ID?>" title="Тема начата <?echo $f_START_DATE?>"><?echo $f_TITLE?></a>
				<?
			...
			<td class="forumbodytext">
				...
				<a href="read.php?FID=<?echo $f_FORUM_ID;?>&TID=<?echo $f_ID?>&MID=<?echo $f_LAST_MESSAGE_ID?>#message<?echo $f_LAST_MESSAGE_ID?>">Автор:</a>
