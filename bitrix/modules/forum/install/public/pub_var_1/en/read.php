...
//	$arTopic = CForumTopic::GetByID($TID);
	$topic = CForumTopic::GetListEx(array(), array("ID"=>$TID));
	$arTopic = $topic->Fetch();
endif;
...
<?endif;?>		
		<td class="forumtitletext" width="99%">Topic: <b><?echo htmlspecialcharsEx($arTopic["TITLE"]);?></b><?
		if (strlen($arTopic["DESCRIPTION"])>0)
		{
			echo ", ".htmlspecialcharsEx($arTopic["DESCRIPTION"]);
		}
		?></td>
		<td nowrap width="1%" align="right" class="forumtitletext">&nbsp;Views: <?echo $arTopic["VIEWS"]?></td>
		</tr>
		</table>
</td>
	</tr>
...
<p class="text"><?echo $db_Message->NavPrint("Posts")?></p>
