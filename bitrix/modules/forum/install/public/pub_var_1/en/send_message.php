...
if ($REQUEST_METHOD=="POST" && $ACTION=="SEND" && $bUserFound)
{
	...
	if (strlen($EMAIL)<=0)
		$strErrorMessage .= "Please enter your ".(($TYPE=="ICQ") ? "ICQ number" : "E-Mail address").". \n";
	elseif ($TYPE!="ICQ" && !check_email($EMAIL))
		$strErrorMessage .= "E-Mail address is not correct. \n";

	if (strlen($SUBJECT)<=0)
		$strErrorMessage .= "Please enter message title. \n";
	if (strlen($MESSAGE)<=0)
		$strErrorMessage .= "Please enter message text. \n";
	if ($TYPE=="ICQ" && strlen($x_PERSONAL_ICQ)<=0)
		$strErrorMessage .= "Destination ICQ number is not set. \n";
	if ($TYPE=="MAIL" && strlen($x_EMAIL)<=0)
		$strErrorMessage .= "Destination E-Mail address is not set. \n";
	...
	<table border="0" cellpadding="1" cellspacing="1" width="100%">
		<tr>
			<td colspan="2" class="forumhead">
				<font class="forumheadtext">&nbsp;<b><?echo $strTextType; ?> to</b></font>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" class="forumhead">
				<font class="forumheadtext">&nbsp;<b><?echo $strTextType; ?> from</b></font>
			</td>
		</tr>
		<tr>
			<td class="forumbody"><font class="forumheadtext">&nbsp;Name</font></td>
		...
		<tr>
			<td class="forumbody">
				...
				if ($TYPE=="ICQ") echo "ICQ number";
				else echo "E-Mail address";
				?> </nobr></font>
			</td>
			<td class="forumbody"><font class="forumbodytext">
				<?
		...
		<tr>
			<td class="forumbody" valign="top">
				<font class="forumheadtext">&nbsp;Subject</font>
			</td>
			<td class="forumbody">
		...
		<tr>
			<td class="forumbody" valign="top">
				<font class="forumheadtext">&nbsp;Message</font>
			</td>
			<td class="forumbody">
		...
		<tr>
			<td  class="forumbody" align="center" colspan="2">
				<input type="submit" value="Send <?echo $strTextType; ?>">
			</td>
		</tr>
	</table>
