<?
if(!is_set($MESSAGE_TYPE) || ($MESSAGE_TYPE!="REPLY" && $MESSAGE_TYPE!="EDIT")) 
	$MESSAGE_TYPE = "NEW";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="100%" class="forumtitle"><b><?
				if($MESSAGE_TYPE=="NEW")
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="forumborder">
<tr><td>
	<table width="100%" border="0" cellspacing="0" cellpadding="3" class="forumbody">
	<form action="<?echo $APPLICATION->GetCurPage();?>?FID=<?echo $FID;?>&TID=<?echo $TID;?>" method="post" name="REPLIER" enctype="multipart/form-data" onsubmit="return ValidateForm(this);">
		...
		<?if ($MESSAGE_TYPE=="NEW" 
			...
			<tr valign="top" class="forumbody">
				...
				<td width="100%">
					<?
					echo ForumPrintIconsList(7, "ICON_ID", $str_ICON_ID, "без иконки", LANG);
					?>
				</td>
			</tr>
		<?endif;?>
		...
		<tr valign="top" class="forumbody">
			<td>
				<?if ($arForum["ALLOW_SMILES"]=="Y"):?>
					<br>
					<table align="center" cellspacing="1" cellpadding="2" border="0" style="border-width:1px; border-color:#999999; border-style:solid;">
						<tr>
			...
			<td width="100%">
				...
				<table cellpadding='2' cellspacing='2' width='100%' align='center'>
					<tr>
						<td nowrap width='10%'>
							<input type='button' accesskey='b' value='B' onClick='simpletag("B")' style="width: 25px; font-size: 8.5pt; font-family: verdana, helvetica, sans-serif; vertical-align: middle; font-weight:bold" name='B' title="Жирный текст (alt + b)" onMouseOver="show_hints('bold')">
							<input type='button' accesskey='i' value='I' onClick='simpletag("I")' style="width: 25px; font-size: 8.5pt; font-family: verdana, helvetica, sans-serif; vertical-align: middle; font-style:italic" name='I' title="Наклонный текст (alt + i)" onMouseOver="show_hints('italic')">
							<input type='button' accesskey='u' value='U' onClick='simpletag("U")' style="width: 25px; font-size: 8.5pt; font-family: verdana, helvetica, sans-serif; vertical-align: middle; text-decoration:underline" name='U' title="Подчеркнутый текст (alt + u)" onMouseOver="show_hints('under')">
							...
							<input type='button' accesskey='c' value='[/]' onClick='closeall()' style="width: 25px; font-size: 8.5pt; font-family: verdana, helvetica, sans-serif; vertical-align: middle;" name='' title="Закрыть все теги (alt + c)" onMouseOver="show_hints('close')">
						</td>
					</tr>
					<tr>
						<td align='left'>
