<?
$MESS["FS_SEARCH"]="Поиск";
$MESS["FS_KEYWORDS"]="Ключевые слова:";
$MESS["FS_FORUM"]="Искать в форуме:";
$MESS["FS_ALL_FORUMS"]="Все форумы";
$MESS["FS_DO_SEARCH"]="Искать";
$MESS["FS_PHRASE_ERROR"]="В поисковой фразе обнаружена ошибка:";
$MESS["FS_PHRASE_ERROR_CORRECT"]="Исправьте поисковую фразу и повторите поиск.";
$MESS["FS_PHRASE_ERROR_SYNTAX"]="Синтаксис поискового запроса:";
...
$MESS["FS_SEARCH_RESULTS"]="Результаты поиска";
$MESS["FS_EMPTY"]="Ничего не найдено. Попробуйте переформулировать запрос.";
$MESS["FS_NO_SEARCH_MODULE"]="Модуль поиска не установлен.";
$MESS["FS_NO_MODULE"]="Модуль форума не установлен";

$MESS["FS_FTITLE"]="Поиск по форуму";
?>