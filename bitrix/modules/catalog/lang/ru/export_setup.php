...
$MESS ['CES_NOTES1'] = "Агенты - это PHP функции которые запускаются с определенной периодичностью. В самом начале загрузки каждой страницы система автоматически проверяет есть ли агент который нуждается в запуске и в случае необходимости исполняет его. Не рекомендуется вешать на агенты длительные по времени выгрузки. Для этих случаев лучше использовать cron.";
