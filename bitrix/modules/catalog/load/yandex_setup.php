		...
		<table width="100%">
			<tr>
				...
				<td width="100%" valign="top">
					<select name="IBLOCK_ID" OnChange="document.getElementById('id_ifr').src='/bitrix/php_interface/include/catalog_export/yandex_util.php?IBLOCK_ID='+this[this.selectedIndex].value;">
...
//										space = '<input type="checkbox" name="V[]" value="'+i+'"><a href="' + Tree[node][i][1] + '">' + Tree[node][i][0] + '</a>';
					...
					<iframe src="/bitrix/php_interface/include/catalog_export/yandex_util.php?IBLOCK_ID=<?=$IBLOCK_ID?>" id="id_ifr" name="ifr" style="display:none"></iframe>
					<br><br>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="100%" valign="top">
					<font class="text">
					<?echo GetMessage("CET_SAVE_FILENAME");?> <input type="text" name="SETUP_FILE_NAME" value="<?echo (strlen($SETUP_FILE_NAME)>0) ? $SETUP_FILE_NAME : (COption::GetOptionString("catalog", "export_default_path", "/upload/"))."yandex.php" ?>" size="50">
					</font>
					<br><br>
				</td>
			</tr>
