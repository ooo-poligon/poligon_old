		...
		<table width="100%">
			<tr>
				...
				<td width="100%" valign="top">
					<select name="IBLOCK_ID" OnChange="document.getElementById('ifr').src='/bitrix/php_interface/include/catalog_export/froogle_util.php?IBLOCK_ID='+this[this.selectedIndex].value;">
...
//										space = '<input type="checkbox" name="V[]" value="'+i+'"><a href="' + Tree[node][i][1] + '">' + Tree[node][i][0] + '</a>';
					...
					<iframe src="/bitrix/php_interface/include/catalog_export/froogle_util.php?IBLOCK_ID=<?=$IBLOCK_ID?>" id="ifr" name="ifr" style="display:none"></iframe>
					<br><br>
				</td>
			</tr>
