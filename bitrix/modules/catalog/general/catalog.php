...
class CAllCatalog
{
	...
	function GetByID($ID)
	{
		...
		if (isset($GLOBALS["CATALOG_CATALOG_CACHE_".$ID]) && is_array($GLOBALS["CATALOG_CATALOG_CACHE_".$ID]) && isset($GLOBALS["CATALOG_CATALOG_CACHE_".$ID]["ID"]))
		{
			return $GLOBALS["CATALOG_CATALOG_CACHE_".$ID];
		}
		else
		{
			$strSql = 
			...
			if ($res = $db_res->Fetch())
			{
				$GLOBALS["CATALOG_CATALOG_CACHE_".$ID] = $res;
				return $res;
			}
		}
	...
	function Update($ID, $arFields)
	{
		...
		unset($GLOBALS["CATALOG_CATALOG_CACHE_".$ID]);
