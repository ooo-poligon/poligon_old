...
<?$tabControl->BeginNextTab();?>
	...
	<tr>
		...
		<td><div id="cyrrency_rate_query_div" style="display:inline;"></div><input type="text" name="RATE" value="<?=$str_RATE?>" size="12">&nbsp;<input type="button" title="<?echo GetMessage("curr_rates_query_ex")?>" value="<?echo GetMessage("curr_rates_query")?>" OnClick="GetAdminDiv('cyrrency_rate_query_div','currency_rate_query.php?');"><div id="cyrrency_query_error_div"></div></td>
	</tr>
