...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $CURRENCY_RIGHT=="W" && strlen($Update)>0 && check_bitrix_sessid())
{
	...
	if (CheckFields($arFields, $ID))
	{
		...
		else
		{
			...
			LocalRedirect("/bitrix/admin/currency_edit.php?ID=".$ID);
		}
	}
	else
	{
...
$arTemplates = Array(
	...
	Array("TEXT" => "ˆ2.345,20", "FORMAT" => "ˆ#", "DEC_POINT" => ",", "THOUSANDS_VARIANT" => "D", "DECIMALS" => "2", ),
	Array("TEXT" => "ˆ2 345,20", "FORMAT" => "ˆ#", "DEC_POINT" => ",", "THOUSANDS_VARIANT" => "S", "DECIMALS" => "2", ),
);
...
<?$tabControl->BeginNextTab();?>
	...
	<tr>
		...
		<td><input class="typeinput" title="<?echo GetMessage("CURRENCY_FORMAT_DESC")?>" type="text" maxlength="50" size="10" name="FORMAT_STRING_<?echo $arLangsLID[$i]?>" value="<?=${"l_FORMAT_STRING_".$arLangsLID[$i]}?>"></td>
	</tr>
	<tr>
