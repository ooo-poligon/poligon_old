...
$aMenu = array(
		array(
				...
				"LINK" => "/bitrix/admin/sale_affiliate.php?lang=".LANG."&".GetFilterParams("filter_", false),
				"ICON" => "btn_list"
			)
	);
...
if ($ID > 0)
{
	...
	$aMenu[] = array(
			...
			"LINK" => "/bitrix/admin/sale_affiliate_edit.php?lang=".LANG."&".GetFilterParams("filter_", false),
			"ICON" => "btn_new"
		);
