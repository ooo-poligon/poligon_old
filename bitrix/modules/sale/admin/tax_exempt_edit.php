...
$sDocTitle = eregi_replace("#ID#", "$ID", GetMessage("EXEMPT_EDIT_RECORD"));
...
$aMenu = array(
		array(
				...
				"ICON" => "btn_list",
				"LINK" => "/bitrix/admin/sale_tax_exempt.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/bitrix/admin/sale_tax_exempt.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
?>
