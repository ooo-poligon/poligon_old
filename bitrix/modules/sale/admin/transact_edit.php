...
$aMenu = array(
		array(
				...
				"LINK" => "/bitrix/admin/sale_transact_admin.php?lang=".LANG."&".GetFilterParams("filter_", false),
				"ICON" => "btn_list"
			)
	);
...
<input type="submit" name="save" value="<?= GetMessage("STE_SAVE") ?>" <?if ($saleModulePermissions < "U") echo "disabled" ?>>&nbsp;<input type="button" value="<?echo GetMessage("STE_CANCEL1")?>" OnClick="window.location='/bitrix/admin/sale_transact_admin.php?lang=<?= LANG ?>&<?= GetFilterParams("filter_", false) ?>'">
