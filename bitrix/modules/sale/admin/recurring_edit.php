...
$aMenu = array(
		array(
				...
				"ICON" => "btn_list",
				"LINK" => "/bitrix/admin/sale_recurring_admin.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
...
if ($ID > 0 && $saleModulePermissions >= "U")
{
	...
	$aMenu[] = array(
			...
			"ICON" => "btn_new",
			"LINK" => "/bitrix/admin/sale_recurring_edit.php?lang=".LANG."&".GetFilterParams("filter_", false)
		);
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/bitrix/admin/sale_recurring_admin.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
?>
