...
$sDocTitle = (strlen($ID)>0) ? eregi_replace("#ID#", "$ID", GetMessage("SALE_EDIT_RECORD")) : GetMessage("SALE_NEW_RECORD");
...
$aMenu = array(
		array(
				...
				"ICON" => "btn_list",
				"LINK" => "/bitrix/admin/sale_status.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
...
if (strlen($ID) > 0 && $saleModulePermissions >= "W")
{
	...
	$aMenu[] = array(
			...
			"ICON" => "btn_new",
			"LINK" => "/bitrix/admin/sale_status_edit.php?lang=".LANG."&".GetFilterParams("filter_", false)
		);
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/bitrix/admin/sale_status.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
?>
