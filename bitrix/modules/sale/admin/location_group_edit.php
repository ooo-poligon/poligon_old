...
$sDocTitle = ($ID>0) ? eregi_replace("#ID#", "$ID", GetMessage("SALE_EDIT_RECORD")) : GetMessage("SALE_NEW_RECORD");
...
$aMenu = array(
		array(
				...
				"ICON" => "btn_list",
				"LINK" => "/bitrix/admin/sale_location_group_admin.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
...
if ($ID > 0 && $saleModulePermissions >= "W")
{
	...
	$aMenu[] = array(
			...
			"ICON" => "btn_new",
			"LINK" => "/bitrix/admin/sale_location_group_edit.php?lang=".LANG."&".GetFilterParams("filter_", false)
		);
	...
	<tr>
		...
		<td valign="top">
			<select name="LOCATION_ID[]" size="10" multiple>
				...
				if ($bInitVars) $arCurLocs = $LOCATION_ID;
				?>
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/bitrix/admin/sale_location_group_admin.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
?>
