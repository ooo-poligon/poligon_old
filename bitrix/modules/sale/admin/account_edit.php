...
$aMenu = array(
		array(
				...
				"LINK" => "/bitrix/admin/sale_account_admin.php?lang=".LANG."&".GetFilterParams("filter_", false),
				"ICON"	=> "btn_list",
...
if ($ID > 0 && $saleModulePermissions >= "U")
{
	...
	$aMenu[] = array(
			...
			"LINK" => "/bitrix/admin/sale_account_edit.php?lang=".LANG."&".GetFilterParams("filter_", false),
			"ICON"	=> "btn_new",
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/bitrix/admin/sale_account_admin.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
?>
