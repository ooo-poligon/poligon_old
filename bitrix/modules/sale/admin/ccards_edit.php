...
$aMenu = array(
		array(
				...
				"LINK" => "/bitrix/admin/sale_ccards_admin.php?lang=".LANG."&".GetFilterParams("filter_", false),
				"ICON" => "btn_list"
			)
	);
...
if ($ID > 0 && $saleModulePermissions >= "U")
{
	...
	$aMenu[] = array(
			...
			"LINK" => "/bitrix/admin/sale_ccards_edit.php?lang=".LANG."&".GetFilterParams("filter_", false),
			"ICON" => "btn_new"
		);
