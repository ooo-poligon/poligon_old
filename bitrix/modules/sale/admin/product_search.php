...
if (!$bBadBlock)
{
	...
	while ($arItems = $dbResultList->NavNext(true, "f_"))
	{
		...
		$arParams = "{'id' : '".$arItems["ID"]."', 'name' : '".htmlspecialchars(str_replace("'", "\'", str_replace("\\", "\\\\", $arItems["NAME"])))."', 'url' : '".htmlspecialchars(str_replace("'", "\'", str_replace("\\", "\\\\", $URL)))."', 'price' : '".htmlspecialchars(str_replace("'", "\'", str_replace("\\", "\\\\", $currentPrice)))."', 'currency' : '".htmlspecialchars(str_replace("'", "\'", str_replace("\\", "\\\\", $arPrice["PRICE"]["CURRENCY"])))."', 'weight' : '".IntVal($arCatalogProduct["WEIGHT"])."', 'priceType' : '".htmlspecialchars(str_replace("'", "\'", str_replace("\\", "\\\\", $arPrice["PRICE"]["CATALOG_GROUP_NAME"])))."', 'catalogXmlID' : '".htmlspecialchars(str_replace("'", "\'", str_replace("\\", "\\\\", $arIBlock["XML_ID"])))."', 'productXmlID' : '".htmlspecialchars(str_replace("'", "\'", str_replace("\\", "\\\\", $f_XML_ID)))."'}";
