...
$aMenu = array(
	array(
		...
		"LINK" => "/bitrix/admin/sale_person_type.php?lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_list"
	)
);
...
if ($ID > 0 && $saleModulePermissions >= "W")
{
	...
	$aMenu[] = array(
		...
		"LINK" => "/bitrix/admin/sale_person_type_edit.php?lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_new"
	);
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/bitrix/admin/sale_person_type.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
?>
