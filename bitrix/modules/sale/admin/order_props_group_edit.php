...
$aMenu = array(
	array(
		...
		"ICON" => "btn_list",
		"LINK" => "/bitrix/admin/sale_order_props_group.php?lang=".LANG."&".GetFilterParams("filter_", false)
	)
);
...
if ($ID > 0 && $saleModulePermissions >= "W")
{
	...
	$aMenu[] = array(
		...
		"ICON" => "btn_new",
		"LINK" => "/bitrix/admin/sale_order_props_group_edit.php?lang=".LANG."&".GetFilterParams("filter_", false)
	);
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/bitrix/admin/sale_order_props_group.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
?>
