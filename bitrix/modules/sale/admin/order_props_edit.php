...
$aMenu = array(
	array(
		...
		"ICON" => "btn_list",
		"LINK" => "/bitrix/admin/sale_order_props.php?lang=".LANG."&".GetFilterParams("filter_", false)
	)
);
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/bitrix/admin/sale_order_props.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
?>
