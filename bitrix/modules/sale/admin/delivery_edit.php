...
$aMenu = array(
		array(
				...
				"LINK" => "/bitrix/admin/sale_delivery.php?lang=".LANG."&".GetFilterParams("filter_", false),
				"ICON" => "btn_list"
			)
	);
...
if ($ID > 0 && $saleModulePermissions >= "W")
{
	...
	$aMenu[] = array(
			...
			"LINK" => "/bitrix/admin/sale_delivery_edit.php?lang=".LANG."&".GetFilterParams("filter_", false),
			"ICON" => "btn_new"
		);
...
?>
	...
	<tr>
		<td width="40%"><?echo GetMessage("F_WEIGHT")?>:</td>
		<td width="60%">
			<?echo GetMessage("SALE_FROM")?>
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/bitrix/admin/sale_delivery.php?lang=".LANG."&".GetFilterParams("filter_", false)
			)
	);
?>
