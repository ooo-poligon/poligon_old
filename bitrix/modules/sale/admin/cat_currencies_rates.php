...
include(GetLangFileName($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/sale/lang/", "/cat_currencies_rates.php"));
...
<?echo BeginFilter("CATALOG_CURRENCY_RATE", $bFilterIsSet);?>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<td width="0%">
						...
						<input type="hidden" name="set_filter" value="Filter">
					...
					<td width="100%" align="left">
						<font class="tablebodytext">
						<input class="button" type="submit" name="del_filter" value="<?echo GetMessage("SALE_F_DEL")?>">
						</font>
					</td>
					<td width="0%"><?ShowAddFavorite(false, "set_filter", "sale")?></td>
				</tr>
			</table>
		</td>
	</tr>
