...
Class sale extends CModule
{
	...
	function InstallDB()
	{
		...
		RegisterModuleDependences("main", "OnUserDelete", "sale", "CSaleAffiliate", "OnUserDelete");
		RegisterModuleDependences("main", "OnUserDelete", "sale", "CSaleAuxilliary", "DeleteByUserID");
	...
	function UnInstallDB($arParams = array())
	{
		...
		UnRegisterModuleDependences("main", "OnUserDelete", "sale", "CSaleAffiliate", "OnUserDelete");
		UnRegisterModuleDependences("main", "OnUserDelete", "sale", "CSaleAuxilliary", "DeleteByUserID");
