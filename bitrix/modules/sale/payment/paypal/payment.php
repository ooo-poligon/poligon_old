...
<form action="https://www.<?=$domain?>paypal.com/cgi-bin/webscr" method="post">
  ...
  <tr>
	<td align="center">
		...
		{
			?>
			<input type="hidden" name="on0" value="<?=urlencode(CSalePaySystemAction::GetParamValue("ON1"))?>">
			<input type="hidden" name="os0" value="<?=urlencode(CSalePaySystemAction::GetParamValue("OS1"))?>">
			<?
		}		
