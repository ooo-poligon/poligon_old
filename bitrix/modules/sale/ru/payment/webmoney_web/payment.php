<form id="pay" name="pay" method="POST" action="https://merchant.webmoney.ru/lmi/payment.asp">
	...
	<input type="hidden" name="LMI_PAYMENT_DESC" value="Заказ <?= CSalePaySystemAction::GetParamValue("ORDER_ID") ?> от <?= htmlspecialchars(CSalePaySystemAction::GetParamValue("SATE_INSERT")) ?>">
