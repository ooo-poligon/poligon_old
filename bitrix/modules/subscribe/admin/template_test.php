...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="list-table">
	...
	<tr>
		...
		<td align="right" width="10%"><?=htmlspecialchars($key)?></td>
		<td align="left"  width="70%" class="right"><?=$value?htmlspecialchars($value):"&nbsp"?></td>
	</tr>
	<?endforeach?>
</table>
</div>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="list-table">
	...
	<tr>
		<td align="left"  width="20%" class="left"><?echo $arFieldDescriptions[$key]?></td>
		<td align="right" width="10%"><?=htmlspecialchars($key)?></td>
		<td align="left"  width="70%" class="right"><?=$value?htmlspecialchars(print_r($value, true)):"&nbsp"?></td>
	</tr>
	<?endforeach?>
</table>
</div>
