	...
	{	
		...
		{//MULTIPLE changed
			...
			{//MULTIPLE=Y
				...
				if(!$DB->Query($strSql))
				{
					$this->LAST_ERROR = GetMessage("IBLOCK_PROPERTY_CHANGE_ERROR",array("#ID#"=>$ID,"#CODE#"=>"MY01"));
					return false;
				}
				$strSql = "
				...
				if(!$DB->Query($strSql))
				{
					$this->LAST_ERROR =  GetMessage("IBLOCK_PROPERTY_CHANGE_ERROR",array("#ID#"=>$ID,"#CODE#"=>"MY02"));
					return false;
				}
				$strSql = "
				...
				if(!$DB->Query($strSql))
				{
					$this->LAST_ERROR =  GetMessage("IBLOCK_PROPERTY_CHANGE_ERROR",array("#ID#"=>$ID,"#CODE#"=>"MY03"));
					return false;
				}
			}
			else
			{//MULTIPLE=N
				...
				";
			 	if(!$DB->Query($strSql))
				{
					$this->LAST_ERROR =  GetMessage("IBLOCK_PROPERTY_CHANGE_ERROR",array("#ID#"=>$ID,"#CODE#"=>"MY04"));
					return false;
				}
				switch($arFields["PROPERTY_TYPE"])
				{
				...
				if(!$DB->Query($strSql))
				{
					$this->LAST_ERROR =  GetMessage("IBLOCK_PROPERTY_CHANGE_ERROR",array("#ID#"=>$ID,"#CODE#"=>"MY05"));
					return false;
				}
				$strSql = "
					DELETE FROM
				...
				if(!$DB->Query($strSql))
				{
					$this->LAST_ERROR =  GetMessage("IBLOCK_PROPERTY_CHANGE_ERROR",array("#ID#"=>$ID,"#CODE#"=>"MY06"));
					return false;
				}
			}
		}
		...
		{//MULTIPLE not changed
			...
			&& $arProperty["MULTIPLE"]=="N")
			{
				...
				";
			 	if(!$DB->Query($strSql))
				{
					$this->LAST_ERROR =  GetMessage("IBLOCK_PROPERTY_CHANGE_ERROR",array("#ID#"=>$ID,"#CODE#"=>"MY07"));
					return false;
				}
			}
		}
