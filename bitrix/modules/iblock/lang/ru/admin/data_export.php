...
$MESS ['CATI_PAGE_TITLE'] = "Выгрузка информационного блока: шаг";
...
$MESS ['CATI_FI_CATDESCR_TYPE'] = "Тип описания для списка (html/text)";
$MESS ['CATI_FI_DETIMG'] = "Картинка";
$MESS ['CATI_FI_DETDESCR'] = "Описание";
$MESS ['CATI_FI_DETDESCR_TYPE'] = "Тип описания (html/text)";
...
$MESS ['ICE_TAB1'] = "Инфоблок";
$MESS ['ICE_TAB1_ALT'] = "Выбор информационного блока для экспорта";
$MESS ['ICE_TAB2'] = "Параметры экспорта";
$MESS ['ICE_TAB2_ALT'] = "Настройка параметров экспорта";
$MESS ['ICE_TAB3'] = "Результат";
$MESS ['ICE_TAB3_ALT'] = "Результат экспорта";
$MESS ['ICE_DATA_FILE_NAME1_T'] = "(относительно корня сайта)";
$MESS ['ICE_2_1_STEP'] = "Вернуться на первый шаг";
$MESS ['CATI_NAME_ERROR'] = "Имя файла (папки) может состоять только из символов латинского алфавита, цифр, пробела, а также символов: !#\$%&()[]{}+-.;=@^_~";
?>