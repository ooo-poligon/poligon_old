...
if ($REQUEST_METHOD == "POST" && $STEP > 1 && check_bitrix_sessid())
{
	...
	if ($STEP > 2)
	{
		...
		{
			$strError .= GetMessage("CATI_NAME_ERROR")."<br>";
		}
		else
		{
...
<?
$aTabs = array(
		array("DIV" => "edit1", "TAB" => GetMessage("ICE_TAB1"), "ICON" => "iblock", "TITLE" => GetMessage("ICE_TAB1_ALT")),
		array("DIV" => "edit2", "TAB" => GetMessage("ICE_TAB2"), "ICON" => "iblock", "TITLE" => GetMessage("ICE_TAB2_ALT")),
		array("DIV" => "edit3", "TAB" => GetMessage("ICE_TAB3"), "ICON" => "iblock", "TITLE" => GetMessage("ICE_TAB3_ALT"))
	);
...
if ($STEP == 2)
{
	...
	<tr>
		<td valign="top"><?echo GetMessage("CATI_DELIMITER_TYPE") ?>:</td>
		<td valign="top">
			<input type="radio" name="delimiter_r" id="delimiter_TZP" value="TZP" <?if ($delimiter_r=="TZP" || strlen($delimiter_r)<=0) echo "checked"?>><label for="delimiter_TZP"><?echo GetMessage("CATI_TZP") ?></label><br>
			<input type="radio" name="delimiter_r" id="delimiter_ZPT" value="ZPT" <?if ($delimiter_r=="ZPT") echo "checked"?>><label for="delimiter_ZPT"><?echo GetMessage("CATI_ZPT") ?></label><br>
			<input type="radio" name="delimiter_r" id="delimiter_TAB" value="TAB" <?if ($delimiter_r=="TAB") echo "checked"?>><label for="delimiter_TAB"><?echo GetMessage("CATI_TAB") ?></label><br>
			<input type="radio" name="delimiter_r" id="delimiter_SPS" value="SPS" <?if ($delimiter_r=="SPS") echo "checked"?>><label for="delimiter_SPS"><?echo GetMessage("CATI_SPS") ?></label><br>
			<input type="radio" name="delimiter_r" id="delimiter_OTR" value="OTR" <?if ($delimiter_r=="OTR") echo "checked"?>><label for="delimiter_OTR"><?echo GetMessage("CATI_OTR") ?></label>
	...
	<tr>
		<td><?echo GetMessage("CATI_FIRST_LINE_NAMES") ?>:</td>
		<td>
	...
	<tr>
		<td colspan="2">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="internal">
				<tr class="heading">
					<td><?echo GetMessage("CATI_FIELDS_NEEDED") ?></td>
					<td><?echo GetMessage("CATI_FIELDS_NAMES") ?></td>
					<td><?echo GetMessage("CATI_FIELDS_SORTING") ?></td>
				</tr>
				<?
				$arAvailFields = array(
					...
					array("value"=>"IE_PREVIEW_TEXT_TYPE", "name"=>GetMessage("CATI_FI_CATDESCR_TYPE")." (B_IBLOCK_ELEMENT.PREVIEW_TEXT_TYPE)"),
					...
					array("value"=>"IE_DETAIL_TEXT_TYPE", "name"=>GetMessage("CATI_FI_DETDESCR_TYPE")." (B_IBLOCK_ELEMENT.DETAIL_TEXT_TYPE)"),
					array("value"=>"IE_CODE", "name"=>GetMessage("CATI_FI_CODE")." (B_IBLOCK_ELEMENT.CODE)"),
					array("value"=>"IE_TAGS", "name"=>GetMessage("CATI_FI_TAGS")." (B_IBLOCK_ELEMENT.TAGS)"),
				);
	...
	<tr>
		<td valign="top"><?echo GetMessage("CATI_DATA_FILE_NAME1") ?>:<br><small><?echo GetMessage("ICE_DATA_FILE_NAME1_T") ?></small></td>
		<td valign="top">
...
if ($STEP > 2)
{
	?>
	<tr>
		<td colspan="2"><b><?echo GetMessage("CATI_SUCCESS") ?></b></td>
	</tr>
	<tr>
		<td colspan="2">
...
<?if ($STEP < 3):?>
	...
	<?endif?>
	<input type="submit" value="<?echo ($STEP==2)?GetMessage("CATI_NEXT_STEP_F"):GetMessage("CATI_NEXT_STEP") ?> &gt;&gt;" name="submit_btn">
<?else:?>
	<input type="submit" name="backButton2" value="&lt;&lt; <?echo GetMessage("ICE_2_1_STEP") ?>">
<?endif;?>
