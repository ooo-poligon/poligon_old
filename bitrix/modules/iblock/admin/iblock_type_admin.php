...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	$row->AddViewField("NAME", htmlspecialcharsex($ibtypelang["NAME"]));
	...
	$row->AddActions(array(
		array("ICON"=>"list", "TEXT"=>GetMessage("IBTYPE_A_IB"), "ACTION"=>$lAdmin->ActionRedirect('iblock_admin.php?lang='.LANG.'&amp;type='.$f_ID.'&amp;admin=Y')),
		...
		//array("ICON"=>"copy", "TEXT"=>GetMessage("MAIN_ADMIN_ADD_COPY"), "ACTION"=>$lAdmin->ActionRedirect('iblock_type_edit.php?COPY_ID='.$f_ID)),
		//array("SEPARATOR"=>true),
