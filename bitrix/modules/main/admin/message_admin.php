...
$lAdmin->AddHeaders(array(
	...
	array("id"=>"LID", "content"=>GetMessage('LANG'), "sort"=>"lid", "default"=>true, "align"=>"center"),
...
{
	$row =& $lAdmin->AddRow($f_ID, $arRes, "message_edit.php?ID=".$f_ID, GetMessage("MAIN_ADMIN_MENU_EDIT_TITLE"));
