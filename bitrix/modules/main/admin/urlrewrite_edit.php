...
if (StrLen($CONDITION) > 0)
{
	...
	$aMenu[] = array(
		...
		"LINK" => "javascript:if(confirm('".GetMessage("MURL_ACT_DEL_CONF")."')) window.location='/bitrix/admin/urlrewrite_list.php?CONDITION=".UrlEncode($CONDITION)."&filter_site_id=".UrlEncode($site_id)."&action=delete&lang=".LANG."&".bitrix_sessid_get()."#tb';",
		"WARNING" => "Y",
		"ICON"	=> "btn_delete"
	);
}
