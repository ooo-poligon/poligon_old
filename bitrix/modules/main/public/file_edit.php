...
function _BXOnBeforeCloseDialog(arParams, dialog_suffix)
{
	...
	jsUtils.removeEvent(pMainObj.pEditorDocument, "keypress", jsPopup.__OnKeyPress);
...
function CheckEditorFinish()
{
	...
	{
		jsPopup.AllowClose();
		jsUtils.addEvent(pMainObj.pEditorDocument, "keypress", jsPopup.__OnKeyPress);
	}
	else
	{
		setTimeout('CheckEditorFinish()', 100);
	}
}
CheckEditorFinish();
