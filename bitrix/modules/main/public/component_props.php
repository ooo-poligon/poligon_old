...
?>
<div class="bx-popup-icon"><img src="<?echo htmlspecialchars($arTemplate["ICON"])?>" width="<?echo $aSize[0]?>" height="<?echo $aSize[1]?>" alt="" border="0"></div>
<?if($arTemplate["NAME"] <> ""):?>
...
if($prop["REFRESH"]=="Y")
	$res .= '<input type="button" value="OK" onclick="jsPopup.PostParameters(\''.
...
<?
	...
	echo '<input id="btn_popup_save" name="btn_popup_save" type="button" value="'.GetMessage("JSPOPUP_SAVE_CAPTION").'" onclick="jsPopup.PostParameters(\'action=save\');" title="'.GetMessage("JSPOPUP_SAVE_CAPTION").'" />'."\r\n";
