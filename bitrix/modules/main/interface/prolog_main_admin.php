...
?>
	...
	<?if (ceil(($SiteExpireDate-time())/86400)>=0):?>
	<?echo GetMessage("TRIAL_ATTENTION_TEXT2") ?> <span class="required"><b><?echo ceil(($SiteExpireDate-time())/86400)?></b></span> <?echo GetMessage("TRIAL_ATTENTION_TEXT3") ?>.
	<?else:?>
