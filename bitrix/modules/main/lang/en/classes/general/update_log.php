...
$MESS ['update_log_nav'] = "Records";
$MESS ['update_log_index'] = "Start page";
$MESS ['update_log_index_title'] = "Go to the start page of SiteUpdate system";
$MESS ['update_log_title'] = "Review update history";
?>
