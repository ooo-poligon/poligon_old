...
class CUserTypeString
{
	...
	function GetSettingsHTML($arUserField = false, $arHtmlControl, $bVarsFromForm)
	{
		...
		<tr valign="top">
			...
			<td>
				<input type="text" name="'.$arHtmlControl["NAME"].'[REGEXP]" size="20"  maxlength="20" value="'.$value.'">
			</td>
		</tr>
		';
		return $result;
	 ...
	 * @static
	 */
	function GetEditFormHTMLMulty2($arUserField, $arHtmlControl)
	{
	 ...
	 * @static
	 */
	function GetAdminListViewHTMLMulty2($arUserField, $arHtmlControl)
	{
	 ...
	 * @static
	 */
	function GetAdminListEditHTMLMulty2($arUserField, $arHtmlControl)
	{
		$result = array();
		foreach($arHtmlControl["VALUE"] as $value)
		{
	 ...
	 * @static
	 */
	function OnBeforeSave2($arUserField, $value)
	{
		if(strlen($value)>0)
