...
function Conf(ob)
{
	if(ob.selectedIndex!=0 && !confirm("<?echo GetMessage("FILEMAN_ACCESS_DIFFERENT")?>"))
		ob.selectedIndex=0;
}
</script>
...
<tr class="heading">
	<td valign="middle" align="center" nowrap>
		<?echo GetMessage("FILEMAN_ACCESS_GROUP")?>
	</td>
	...
	<tr valign="top">
		...
		<td>
			<select name="g_<?echo $g_ID?>" class="typeselect" <?if($bDiff):?>onChange="Conf(this)"<?endif?>>
				<option value=""><?echo GetMessage("FILEMAN_ACCESS_LEVEL_NOTCH")?></option>
		...
		<td>
		<?if($bDiff):?>
			<?echo GetMessage("FILEMAN_ACCESS_DIFF_GROUP")?><br>
	...
	<tr valign="top">
		<td align="left">
			<?echo GetMessage("FILEMAN_ACCESS_GROUP_INHERIT")?>
		</td>
		<td align="left">
...
function ChF()
{
	if(document.faform.g_2.selectedIndex==3 || document.faform.g_2.selectedIndex==4)
		if(!confirm("<?echo GetMessage("FILEMAN_ACCESS_FOR_GROUP")?> <?echo AddSlashes($anonym)?> <?echo GetMessage("FILEMAN_ACCESS_FOR_GROUP2")?>"))
			return false;
	return true;
}
</script>
