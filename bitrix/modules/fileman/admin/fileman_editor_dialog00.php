...
<table height="100%" width="100%" id="t1" border="0">
	<tr height="60%">
		<td colspan="3">
			...
			<tr>
			<td></td>
			<td>Внимание! Редактируемый документ был изменен. Чтобы не потерять изменения необходимо сохранить документ.</td>
			</tr>
			</table>
		</td>
	</tr>
	<tr height="40%" valign="bottom">
		<td align="center" valign="bottom"><input type="button" id="b1" value="Сохранить и выйти" onclick="OnSave('save')"></td>
		<td align="center" valign="bottom"><input type="button" value="Выйти без сохранения" onclick="OnSave('exit')"></td>
		<td align="center" valign="bottom"><input type="button" value="Продолжить редактирование" onclick="OnSave()"></td>
	</tr>
</table>
