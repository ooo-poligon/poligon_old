...
BXHTMLEditor.prototype.OnLoad = function()
{
	...
	var _this = this;
	setTimeout(function (){BXCreateTaskbars(_this, true);}, 50);
	this.SetView("html");
...
BXHTMLEditor.prototype.SetEditorContent = function(sContent)
{
	...
	addEvent(this.pEditorDocument, 'keyup', function (e){obj.OnClick(e); obj.OnChange("keyup", "");});
...
BXHTMLEditor.prototype.SetFocus = function ()
{
	...
	{
		_alert("Error: BXHTMLEditor.prototype.SetFocus");
	}
};
