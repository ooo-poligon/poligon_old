...
$APPLICATION->SetTitle("CITEL – эксперт по защите от импульсных перенапряжений.");
?><h2>CITEL – эксперт по защите от импульсных перенапряжений.</h2>
<iframe width="680" height="404" src="//www.youtube.com/embed/epiV_XXH1JA" frameborder="0" allowfullscreen></iframe>
