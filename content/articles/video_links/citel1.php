...
$APPLICATION->SetTitle("УЗИП CITEL для защиты системы светодиодного оборудования.");
?> 
<h2>УЗИП CITEL для защиты системы светодиодного оборудования.</h2>
 <iframe frameborder="0" width="680" height="404" allowfullscreen="" src="//www.youtube.com/embed/abjWKoLZm4I"></iframe> 
<h4>Другое видео по теме:</h4>
 
<ul class="mark"> 
<!--<li><a href="/content/articles/video_links/citel1.php" target="_self" >УЗИП CITEL для защиты системы светодиодного оборудования.</a></li>-->
