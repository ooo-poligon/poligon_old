...
$APPLICATION->SetTitle("УЗИП CITEL  для защиты фотоэлектрических станций от импульсных перенапряжений.");
?><h2>УЗИП CITEL  для защиты фотоэлектрических станций от импульсных перенапряжений.</h2>
<iframe width="680" height="404" src="//www.youtube.com/embed/z7JXcoUymYc" frameborder="0" allowfullscreen></iframe>

<h4>Другое видео по теме:</h4>
...
<li><a href="/content/articles/video_links/citel2.php" target="_self" >УЗИП CITEL для защиты систем безопасности.</a></li>
