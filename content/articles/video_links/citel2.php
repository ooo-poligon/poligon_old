...
$APPLICATION->SetTitle("УЗИП CITEL для защиты систем безопасности.");
?> 
<h2>УЗИП CITEL для защиты систем безопасности.</h2>
 <iframe frameborder="0" width="680" height="404" src="//www.youtube.com/embed/eoh3oQuWV2g" allowfullscreen=""></iframe> 
