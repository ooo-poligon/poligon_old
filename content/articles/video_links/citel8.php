...
$APPLICATION->SetTitle("CITEL : Технология VG для УЗИП переменного тока и для фотоэлектрических систем.");
?><h2>CITEL : Технология VG для УЗИП переменного тока и для фотоэлектрических систем.</h2>
<iframe width="680" height="404" src="//www.youtube.com/embed/HU3P-gS0gUE" frameborder="0" allowfullscreen></iframe>
