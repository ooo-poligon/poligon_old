...
$APPLICATION->SetTitle("УЗИП CITEL для защиты промышленных объектов.");
?><h2>УЗИП CITEL для защиты промышленных объектов.</h2>
<iframe width="680" height="404" src="//www.youtube.com/embed/G95lLz3g8Ng" frameborder="0" allowfullscreen></iframe>
