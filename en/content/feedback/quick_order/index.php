...
//массив $goReqParam[], может принимать только значения true или false (Поле обязательное или необязательное для заполнения); 
	...
	$goTitle [6]='Наименование 1:';	$goTypeHTML [6]=$goInput; $goName[6]='article1';	$goReqParam[6]=true; 
	...
	$goTitle [16]='Комментарий:';			$goTypeHTML [16]=$goTextArea; $goName[16]='comment';	$goReqParam[16]=true; 
