...
if($fetch_el_pic["FILE_NAME"]) {$picture = '/upload/'.$fetch_el_pic["SUBDIR"].'/'.$fetch_el_pic["FILE_NAME"];}else {$picture = '';}

if($fetch_el_pic_pre["FILE_NAME"]) {$picture_pre = '/upload/'.$fetch_el_pic_pre["SUBDIR"].'/'.$fetch_el_pic_pre["FILE_NAME"];}else {$picture_pre = '';}
